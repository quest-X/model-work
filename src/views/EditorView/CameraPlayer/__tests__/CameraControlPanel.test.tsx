...
const state = {
    exposure: {mode: 'manual' as const, shutter_us: 10000, gain_level: 22},
...
describe('CameraControlPanel', () => {
    ...
    it('shows live metrics and runs automatic exposure', async () => {
        ...
        fireEvent.click(screen.getByRole('button', {name: '自动曝光'}));
