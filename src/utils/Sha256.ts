...
/** Standards-only SHA-256 used when WebCrypto is unavailable on an HTTP origin. */
export const sha256HexFallback = (input: ArrayBuffer | Uint8Array): string => {
...
export const sha256File = async (
    ...
    if (subtle) {
        try {
            ...
            // HTTP origins and hardened browsers can expose subtle but reject use.
        }
    }
